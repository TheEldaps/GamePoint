  ...
  return (
    <div className=" relative flex text-[#ffffff] pt-[30px] pl-[90px] bg-[#000]">
      <div className="min-w-[50%]">
        <h1 className="font-[swiss]  text-[96px] font-[1000] leading-[96px] mb-[20px] mt-[40px] text-left decoration-skip-ink-none">
        ...
        <p className="text-[1.3rem] mb-[40px] font-[swiss]">
      ...
      <div>
        <img className="h-[770px] w-[500px] " src={BackgrdYellow} alt="" />
        <img
          className="absolute bottom-[0px] right-[0px] w-[1400pxpx] h-[770px]"
          src={Halland}
          alt=""
        />
      </div>
